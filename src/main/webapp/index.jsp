...
<input type="button" value="8" onClick="document.calculator.ans.value+='-'">
<input type="button" value="9" onClick="document.calculator.ans.value+='8'">
<input type="button" value="-" onClick="document.calculator.ans.value+='9'">
<input type="button" value="+" onClick="document.calculator.ans.value+='*'"><br>
<input type="button" value="" onClick="document.calculator.ans.value+='0'">
<input type="button" value="/" onClick="document.calculator.ans.value+='BACK'">
